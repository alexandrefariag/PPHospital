 ...
 * @author nunom
 */
public class HomePerfilRececionista extends javax.swing.JFrame {
private Sistema sistema;
private Serializacao bd;
private Rececionista rececionista;
    /**
     * Creates new form HomePerfilRececionista
     */
    public HomePerfilRececionista(Sistema sistema, Serializacao bd) {
        initComponents();
        this.sistema = sistema;
        this.bd=bd;
        rececionista=(Rececionista) sistema.getUtilizadorLigado();
        preencherDados(rececionista);
    }
     ...
     private void preencherDados(Rececionista rececionista){
     ...
     private void editarDados(){
         ...
         sistema.getListaUtilizadores().getRececionista(rececionista.getCodigoU()).setNome(nome.getText().trim());
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 340, 90, 40));
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 340, 130, 40));
