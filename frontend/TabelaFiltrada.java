 ...
 * @author nunom
 */
public class TabelaFiltrada extends AbstractTableModel{     //classe abstrata para tratar dos dados que aparecem nas tabelas
    private final ArrayList<Doente> doentes;
    private static final String[] colunasTabela = new String[]{
        "Código", "Nome", "Enfermaria", "Gravidade", "Data de Entrada", "Data de Saída", "Cama"
    };
    
    public TabelaFiltrada(ArrayList<Doente> doentes)
    {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {       //retorna o valor da lista na determinada
       Doente p = doentes.get(rowIndex);                        //vê na lista doentes, na determinada linha e com isso vai
