 ...
 * @author nunom
 */
public class HomeEnf extends javax.swing.JFrame {
private Sistema sistema;
private Hospital hospital;
private TabelaEnfermarias modeloTabelaEnfermarias;
private Serializacao bd;

    /**
     * Creates new form HomeEnf
     */
    public HomeEnf(Sistema sistema, Serializacao bd) {
        initComponents();
        ...
        modeloTabelaEnfermarias = new TabelaEnfermarias(hospital.getEnfermarias());
        jTable1.setModel(modeloTabelaEnfermarias);
    }
    ...
    int col = 0;
        ...
        EditEnfermaria p = new EditEnfermaria(sistema, codigo, bd, new javax.swing.JFrame(), true);
        p.setVisible(true);
        dispose();
    }
    
    private void removerEnfermaria(){
        int row = jTable1.getSelectedRow();
        int col = 0;
        ...
        for (int i=0; i < hospital.getDoentes().getTotalDoentes(); i++){
            if (hospital.getDoentes().getD(i).getEnfermaria().getCodigoEnf().equals(value)){
                JOptionPane.showMessageDialog(this,"Impossível eliminar enfermaria! Tem doentes associados");
                return;
            }
        }
        
        
        hospital.getEnfermarias().remover(hospital.getEnfermarias().getEnfermaria(value));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Tipo", "Num Camas"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(293, 200, 420, 280));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setText("LISTA DE ENFERMARIAS");
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 230, -1, -1));
        ...
        jPanel1.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 270, 110, -1));
        ...
        jPanel1.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 310, 110, -1));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        AddEnfermaria p = new AddEnfermaria(sistema, bd, new javax.swing.JFrame(), true);
        p.setVisible(true);
        dispose();
